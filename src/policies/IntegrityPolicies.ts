...
function createPolicy(examSlug: string, restrictedKeywords: string[]): IntegrityPolicyDefinition {
  return {
    examSlug,
    version: '2025.1',
...
export const IntegrityPolicies: Record<string, IntegrityPolicyDefinition> = {
